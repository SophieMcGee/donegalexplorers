...
from .views import (
    Home, EventCreateView, EventUpdateView, SavedEventsView,
    EventList, EventDetail, save_event_to_calendar, rate_event,
    BrowseEventsView, EventDeleteView, MyEventsView,
    remove_event_from_calendar, signup_closed, CommentUpdateView,
    CommentDeleteView, ManageEmailView, mark_notification_as_read,
    notifications_view
)
...
urlpatterns = [
    ...
    path(
        'save-event/<int:event_id>/',
        save_event_to_calendar, name='save_event_to_calendar'
    ),
    ...
    path(
        'event-confirmation/',
        TemplateView.as_view(template_name='event_confirmation.html'),
        name='event_confirmation'
    ),
    path(
        'event/<int:pk>/edit/',
        EventUpdateView.as_view(), name='edit_event'
    ),
    path(
        'event/<int:pk>/delete/',
    ...
    path(
        'remove-event/<int:event_id>/',
        remove_event_from_calendar, name='remove_event_from_calendar'
    ),
    ...
    path(
        'manage-email/', ManageEmailView.as_view(), name='manage_email'
    ),
