...
class EventAdmin(SummernoteModelAdmin):
    list_display = (
        'title', 'author', 'location', 'start_date',
        'end_date', 'start_time', 'end_time', 'created_on'
    )
    search_fields = ('title', 'description', 'location', 'slug')
    list_filter = ('start_date', 'author')
    ordering = ('-start_date',)
    summernote_fields = ('description',)  # Enable Summernote
    ...
    publish_events.short_description = (
...
class CommentAdmin(admin.ModelAdmin):
    ...
    approve_comments.short_description = (
